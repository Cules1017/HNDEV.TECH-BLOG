    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                ...
                <form class="m-4" method="POST" action="{{ route('feedback.store') }}"  enctype="multipart/form-data">
                        @csrf
                ...
                <p class="contact_sub">Vui lòng điền nội dung bạn muốn góp ý vào form bên dưới, đội ngũ admin sẽ liên hệ với bạn sớm nhất có thể.</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('mail')}}" class="form-control  @error('mail') is-invalid @enderror" id="mail" name="mail" placeholder="Nhập vào tên sliders">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            @error('name')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('title_fb')}}" class="form-control  @error('title_fb') is-invalid @enderror" id="title_fb" name="title_fb" placeholder="Nhập vào tên sliders">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            @error('descript')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content_fb" id="content_fb" cols="30" rows="10" class="form-control  @error('content_fb') is-invalid @enderror">{{old('config_value')}}</textarea>
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            @error('config_value')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="{{old('img_fb')}}" class="form-control-file" id="img_fb" name="img_fb">
                        </div>
