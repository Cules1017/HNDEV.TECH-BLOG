        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form class="m-4" method="POST" action="{{ route('menus.update',$menu->id) }}">
                        @csrf
                        <div class="form-group">
                            <label for="name">Tên danh mục:</label>
                            <input type="text" class="form-control" id="name" name="name" value="{{ $menu['name'] }}" placeholder="Nhập vào tên danh mục">
