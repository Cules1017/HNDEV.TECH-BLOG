...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form class="m-4" method="POST" action="{{ route('roles.store')}}">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('name')}}" class="form-control  @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nhập vào tên vai trò trong trang">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control  @error('name_display') is-invalid @enderror" id="name_display" rows="5" name="name_display"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="card-body text-primary">
                                            <label for="">
                                                <input name="permission_id[]" type="checkbox" class="cb_child" value="{{ $child->id }}">
                                            </label>
                                            {{ $child->name }}
                                        </div>
                                    </div>
